<template>
  <v-footer dark padless class="mt-12 mb--1" absolute>
    <v-card flat tile class="white--text text-center">
      ...
      <v-card-text class="white--text">
        EFAVAI Tech &copy; {{ new Date().getFullYear() }}
      </v-card-text>
    </v-card>
  </v-footer>
</template>
...
export default {
  data: () => ({
    icons: ["mdi-facebook","mdi-facebook-messenger", "mdi-twitter", "mdi-linkedin", "mdi-instagram","mdi-whatsapp"],
  }),
};
</script>
